...
R5.2.1)the third party can define the interval between updates for each specific parameter \\ \\
...
\textbf{G4) Registered users can visualize the list of live runs} \\ \\
